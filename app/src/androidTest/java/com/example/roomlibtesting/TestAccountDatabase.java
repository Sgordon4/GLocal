...
public class TestAccountDatabase {
	...
	@Test
	public void testAccountLoads() throws ExecutionException, InterruptedException {
		System.out.println("Testing account PUT (INSERT/UPDATE) functionality!");

		LAccountDAO dao = db.getAccountDao();

		List<LAccount> accounts = dao.loadAll().get();
		assertTrue(accounts.isEmpty());							//Ensure we start with 0 rows
	...
	@Test
	public void testAccountDeleteByUUID() {
	...
	@Test
	public void testFileDeleteByUUID() throws ExecutionException, InterruptedException {
